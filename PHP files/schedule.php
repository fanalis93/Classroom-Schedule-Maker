                ...
                <div class="col">
                    ...
                    <table class="table my-0" id="dataTable-1">
                        <thead>
                            ...
                            <?php 
                            $getres = oci_parse($connection,'SELECT nvl(stud_id,0),nvl(lec_id,0),nvl(class_id,0),nvl(staff_id,0),class_condition,start_time,end_time FROM schedule');
                            oci_execute($getres);
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="delete_	process.php?userid=<?php echo $row["class_id"]; ?>">Delete</a></td>
                                </tr>
                            </tbody>
                            <?php
                            }
