        ...
        <div class="row td-form-wrapper">
            <div class="col td-glass">
                <form class="td-form-wrapper">
                    <h2 class="text-center">Delete Schedule</h2>
                    <div class="form-group">
                        <div class="col-md-12"><label for="name">Classroom ID</label>
                            <div class="d-flex"><input class="form-control d-flex" type="text" autocomplete="off" name="id" placeholder="classroom id" required=""></div>
                        </div>
                        <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <div class="col-md-12"><label for="subject">Start Time</label>
                            <div class="d-flex td-input-container"><input class="form-control" type="text" autocomplete="off" placeholder="2020-08-02 14:00:00" name="subject" inputmode="numeric"></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12"><button class="btn btn-dark float-right" data-bs-hover-animate="swing" type="submit">Delete Schedule</button></div>
                    </div>
                </form>
            </div>
        </div>
