                ...
                <div class="col">
                    ...
                    <table class="table my-0" id="dataTable-1">
                        <thead>
                            ...
                            <?php 
                            $getres = oci_parse($connection,'SELECT class_id,class_capacity,class_location,class_condition,nvl(class_deviceno,0) FROM classroom');
                            oci_execute($getres);
